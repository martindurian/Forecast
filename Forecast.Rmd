...
export_df <- outdoor_df_lst[[1]] %>%
  ...
  pre_installation_path <- file.path("C:/RMV2/Preinstallation/", Building_name)
  if(!dir.exists(pre_installation_path)) dir.create(path = pre_installation_path)
  write_csv(export_df, path = str_c("C:/RMV2/Preinstallation/", Building_name, "/extra_var.csv"))
...
export_setback_df  <- outdoor_df_lst[[1]] %>%
  ...
  post_installation_path <- file.path("C:/RMV2/Postinstallation/", Building_name)
  if(!dir.exists(post_installation_path)) dir.create(path = post_installation_path)
  write_csv(export_setback_df, path = str_c("C:/RMV2/Postinstallation/", Building_name, "/extra_var_setback.csv"))
